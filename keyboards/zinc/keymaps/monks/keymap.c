...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = { \
   ...
   * | Shift|   Z  |   X  |   C  |   V  |   B  |             |   N  |   M  |  ,<  |  .>  |  /?  |  \|  |
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * | Cmd  | Alt  |      |BSpace|Lower |Space |             |Enter |Raise | Tab  |  `~  |  -_  |Shift |
   * `-----------------------------------------'             `-----------------------------------------'
   */
[_QWERTY] = LAYOUT_ortho_4x12(
   ...
   KC_LGUI, KC_LALT, _______, KC_BSPACE, LOWER, KC_SPC,  KC_ENTER, RAISE,  KC_TAB, KC_GRV, KC_MINS, KC_RSFT \
   ),
  ...
  TS_AC_3, TS_AC_4, TS_AC_5, TS_AC_6, LOWER, _______,    _______, _______, _______, _______, _______, _______ \
  ),
